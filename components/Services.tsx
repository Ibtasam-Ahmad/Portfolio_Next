...
const services = [
  ...
  },
  {
    ...
    description: 'Replace expensive manual workflows with intelligent AI pipelines. Clients consistently see 40–70% reduction in operational costs.',
  ...
  },
  {
    ...
    description: 'Launch subscription AI products with payment processing, authentication, and CI/CD deployment — ready to onboard paying customers.',
