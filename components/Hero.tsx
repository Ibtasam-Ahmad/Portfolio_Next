    ...
    >
      <div className="container">
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9375rem', fontWeight: 500, marginBottom: '20px', letterSpacing: '0.02em' }}>
            {hero.location}
          </p>
          ...
          <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <a
              href={hero.whatsappCta.href}
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: 'inline-flex', alignItems: 'center', gap: '8px',
                padding: '14px 24px', borderRadius: 'var(--radius-sm)',
                /* Dark ink on WhatsApp green: white-on-green is only 1.98:1,
                   dark-on-green is 9.9:1 and keeps the brand colour. */
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="#0b1f12">
